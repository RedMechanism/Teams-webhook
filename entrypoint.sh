...
RELEASE_TAG = os.getenv('release_tag', None)
...
if RELEASE_TAG is None:
    ...
    myMessageSection.activityTitle("Release: "+RELEASE_TAG)
...
# Add a text element. It is empty but we need it for proper functionality
...
if RELEASE_TAG is None:
    ...
    myTeamsMessage.addLinkButton("Go to release", "https://github.com/"+REPOSITORY_URL+"/releases/tag/"+RELEASE_TAG)
myTeamsMessage.send()
EOF
